...
final class Auth
{
    ...
    /**
    *包含了 4-6
    *@param string $data 对已经base64_urlSafeEncode的policy(策略)
    *@return 返回对 ak ':' 签名进行URL安全的Base64编码 的拼接
    */
    ...
    /**包含了3-5
    *@param string $data 未进行安全编码的policy(已序列化的策略)
    *@return string 返回 加密后的sign 拼接 ':' 安全编译过的policy
    */
    public function signWithData($data)
    {
        $encodedData = \Qiniu\base64_urlSafeEncode($data);//对policy进行安全url编码
    ...
    *@param string $key 指定上传的文件名
    *@param int $epires 上传文件的有效期
    */
